...
with mp_hands.Hands(
    ...
    while cap.isOpened():
        ...
        if results.multi_hand_landmarks:
            ...
            fingerCount_array = np.array([[fingerCount]])
            gesture_class = np.argmax(custom_model.predict(fingerCount_array), axis=-1)
            ...
            # Add more conditions for other gesture classes if needed
